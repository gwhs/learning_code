...
public class Limelight {
  ...
  public static final NetworkTable table =
      NetworkTableInstance.getDefault().getTable(LIMELIGHT_TABLE_KEY);
  ...
  /**
   * Determines the horizontal angular distance from the crosshair to the center of the bounding box
  ...
  public static void toggleCamMode() {
    ...
    else table.getEntry(MODE_KEY).setNumber(VISION_MODE);
  }
  ...
  public static void toggleLEDs() {
    ...
    else table.getEntry(LED_MODE).setNumber(LED_ON);
  }
  ...
  /**
   * Determines the vertical angular distance from the crosshair to the center of the bounding box
   * representing the target.
   *
  ...
  /**
   * Determines the sidelength of the shortest side of the fitted bounding box. The fitted bounding
   * box is a rectangular convex hull surrounding the selected pixels, while the rough bounding box
   * is a rectangle around the fitted bounding box, put is not rotated
   *
  ...
  /**
   * Determines the sidelength of the longest side of the fitted bounding box. The fitted bounding
   * box is a rectangular convex hull surrounding the selected pixels, while the rough bounding box
   * is a rectangle around the fitted bounding box, put is not rotated
   *
  ...
  /**
   * Determines the horizontal sidelength of the rough bounding box. The fitted bounding box is a
   * rectangular convex hull surrounding the selected pixels, while the rough bounding box is a
   * rectangle around the fitted bounding box, put is not rotated
   *
  ...
  /**
   * Determines the vertical sidelength of the rough bounding box. The fitted bounding box is a
   * rectangular convex hull surrounding the selected pixels, while the rough bounding box is a
   * rectangle around the fitted bounding box, put is not rotated
   *
   ...
   *
   * @return The compute 3D values, in the specified order (x,y,z,pitch,yaw,roll). These values
   *     place the target as the origin and represent the camera's orientation relative to the
   *     target.
   */
